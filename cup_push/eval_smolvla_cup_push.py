...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", type=str, default=None,
                        help="HuggingFace repo or local path to pretrained policy (auto-selected if not set)")
    ...
    task_to_policy = {
        "Move to the blue object": "subhodipsaha/smolvla_cup_push_blue",
        "Move to the red object":  "subhodipsaha/smolvla_cup_push_red",
    }
    policy_path = args.policy or task_to_policy[args.task]
